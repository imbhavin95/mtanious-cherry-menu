    ...
    <tr>
        <td>
            <table style="width: 100%;padding:0 45px;">
                <tr>
                    <td>
                        <p style="font-size: 14px;color: #9B9B9B;line-height: 19px;margin:0;">Hi Admin,</p>
                    <td>
                </tr>
                <tr>
                    <td style="padding: 10px 0;">
                        <p style="font-size: 14px;color: #000;line-height: 19px;margin:0;">Below subscriptions are expiring in coming week!</p>
                    </td>
                </tr>
                <tr>
                    <td style="padding: 10px 0;">
                        ...
                        <table style="width: 100%">
                            <tr>
                                <th style="border: 1px solid; width: 80px; text-align: left">Name</th>
                                <th style="border: 1px solid; width: 200px; text-align: left">Email</th>
                            </tr>
                            <?php
                                foreach ($users as $user){
                            ?>
                            <tr>
                                <td style="border: 1px solid; width: 80px; text-align: left"><?php echo $user['name']; ?></td>
                                <td style="border: 1px solid; width: 200px; text-align: left"><?php echo $user['email']; ?></td>
                            </tr>
                            <?php
                            }
                            ?>
                ...
                <tr>
                    <td>
                        <p style="margin:0;">
                            <a href="<?php echo $url ?>" style="display: inline-block;line-height: 32px;min-width: 133px;background: #CE0E2D;text-align: center;text-decoration: none;color: #fff;font-size: 14px;border-radius: 2px;margin-top: 35px;    margin-bottom: 35px;">Dashboard</a>
                        </p>
                    </td>
                </tr>
                <tr>
