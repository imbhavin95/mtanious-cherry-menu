            ...
            <table style="width: 100%;padding:0 45px;">
                ...
                <tr>
                    <td style="padding: 10px 0;">
                        <p style="font-size: 14px;color: #000;line-height: 19px;margin:0;">Your subscription will expiring on <?php echo $expiring_date; ?>, Please login to dashboard and renew your plan.</p>
                    </td>
                </tr>
                <tr>
                    <td>
                        <p style="margin:0;">
                            <a href="<?php echo $url ?>" style="display: inline-block;line-height: 32px;min-width: 133px;background: #CE0E2D;text-align: center;text-decoration: none;color: #fff;font-size: 14px;border-radius: 2px;margin-top: 35px;    margin-bottom: 35px;">Renew subscription</a>
                        </p>
                    </td>
                </tr>
                <tr>
