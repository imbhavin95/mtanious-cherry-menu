...
if ($_SERVER['HTTP_HOST'] == 'cherrymenu.com') {
    ...
    if ($_SERVER['HTTP_HOST'] == 'www.cherrymenu.com') {
        if ($_SERVER['REQUEST_URI'] == '/login/login/') {
            header('Location: ' . $base_url);
        }
...
<head>
    ...
    <meta name="description"
          content=" Looking for a digital menu board that can amplify your guests’ gratification? Login to Cherrymenu to pick a sassy digital display for your restaurant.">
    ...
    <link href="<?php echo base_url('assets/Backend/validation_jquery/css/cmxform.css'); ?>" rel="stylesheet"
          type="text/css"/>
    <link href="<?php echo base_url('assets/Backend/validation_jquery/css/cmxformTemplate.css'); ?>" rel="stylesheet"
          type="text/css"/>
    <link href="<?php echo base_url('assets/Backend/validation_jquery/css/core.css'); ?>" rel="stylesheet"
          type="text/css"/>
    <link href="<?php echo base_url('assets/Backend/validation_jquery/css/reset.css'); ?>" rel="stylesheet"
          type="text/css"/>
    <link href="<?php echo base_url('assets/Backend/validation_jquery/css/screen.css'); ?>" rel="stylesheet"
          type="text/css"/>
...
<div class="login-form">
        ...
        <div class="form-area">
            ...
            <div class="group">
                <input type="text" name="email" id="email" class="form-control" placeholder="Username"
                       value="<?php echo get_cookie('remember_me_email'); ?>">
            ...
            <div class="checkbox checkbox-primary">
                <input type="checkbox" class="styled" name="remember_me" id="remember_me"
                       value="1" <?php echo get_cookie('remember_me_ck') == true ? 'checked' : '' ?> >
    ...
    <div class="footer-links row">
        <div class="col-xs-12 text-center" style="color:white">Don't have an account? <a
                    href="<?php echo base_url('registration'); ?>" style="color:white"><b><u>Try cherrymenu for free</u></b></a>
        </div>
    </div>
</div>
</body>
