			...
			<table style="width: 100%;padding:0 45px;">
				<tr>
					...
					<td style="padding: 30px 0;">
							<p style="font-size: 14px;color: #000;line-height: 19px;margin:0;">A <?php echo $type; ?> credential has been change, your login info are:</p>
						</td>
					</tr>
					<tr>
						<td>
					...
					<tr>
						<td>
							<p style="margin:0;">
								<a href="<?php echo $url ?>" style="display: inline-block;line-height: 32px;min-width: 133px;background: #CE0E2D;text-align: center;text-decoration: none;color: #fff;font-size: 14px;border-radius: 2px;margin-top: 35px;    margin-bottom: 35px;">Login</a>
						</p>
						</td>
					</tr>
					<tr>
