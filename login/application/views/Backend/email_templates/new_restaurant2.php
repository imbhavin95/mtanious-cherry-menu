			...
			<table style="width: 100%;padding:0 45px;">
				...
				<tr>
					<td style="padding: 10px 0;">
						<p style="font-size: 14px;color: #000;line-height: 19px;margin:0;">Congratulation !  New user signup in Cherrymenu.</p>
						</br>
						<p style="font-size: 14px;color: #000;line-height: 19px;margin:0;">Here is the user Details.</p>
					</td>

				</tr>
				<tr>
					<td style="padding: 30px 0;">
						<p style="font-size: 14px;color: #000;line-height: 19px;margin:0;">User Name : <?php echo $name ; ?></p>
			 <p style="font-size: 14px;color: #000;line-height: 19px;margin:0;">Email Id: <?php echo $email ; ?></p>
			
			<?php if(!empty($phone_number)){ ?>
	   <p style="font-size: 14px;color: #000;line-height: 19px;margin:0;">Phone Number : <?php echo @$phone_number ; ?></p>
			<?php } ?> 
				...
				<!-- <tr>
					<td style="padding: 10px 0;">
						<p style="font-size: 14px;color: #000;line-height: 19px;margin:0;">Before we proceed can you please click the button below to confirm your email?</p>
					</td>
				</tr>
				<tr>
					<td>
						<p style="margin:0;">
							<a href="<?php echo $url ?>" style="display: inline-block;line-height: 32px;min-width: 133px;background: #CE0E2D;text-align: center;text-decoration: none;color: #fff;font-size: 14px;border-radius: 2px;margin-top: 35px;    margin-bottom: 35px;">Confirm Email</a>
					</p>
					</td>
				</tr>
				<tr>
					<td style="padding: 10px 0;">
						<p style="font-size: 14px;color: #000;line-height: 19px;margin:0;">After the confirmation you will have a full access to your account to start enjoying your 30 days trial</p>
					</td>
				</tr> -->
			<!-- 	<tr>
