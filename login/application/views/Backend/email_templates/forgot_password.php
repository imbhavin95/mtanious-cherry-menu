	...
	<tr>
		<td>
			<table style="width: 100%;padding:0 45px;">
				<tr>
						<td>
							<p style="font-size: 14px;color: #9B9B9B;line-height: 19px;margin:0;">Hi <?php echo isset($name) ? $name : ''; ?>,</p>
						<td>
				</tr>
					<tr>
					<td style="padding: 30px 0;">
							<p style="font-size: 14px;color: #000;line-height: 19px;margin:0;">Please click on below link to reset your password. If link is not working then copy & paste URL in your browser </p>
						</td>
					</tr>
					<tr>
						<td>
							<p style="font-size: 14px;color: #9B9B9B;line-height: 19px;margin:0;">URL : <?php echo $url; ?></p>
						</td>
                    </tr>
                    <tr>
                        <td>
                            <p style="margin:0;">
                                <a href="<?php echo $url ?>" style="display: inline-block;line-height: 32px;min-width: 133px;background: #CE0E2D;text-align: center;text-decoration: none;color: #fff;font-size: 14px;border-radius: 2px;margin-top: 35px;    margin-bottom: 35px;">Change Password</a>
                            </p>
                        </td>
				    </tr>
					<tr>
