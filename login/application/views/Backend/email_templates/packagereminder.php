	...
	<tr>
		<td>
			<table style="width: 100%;padding:0 45px;">
				<tr>
						<td>
							<p style="font-size: 14px;color: #9B9B9B;line-height: 19px;margin:0;">Hey <?php echo isset($name) ? $name : ''; ?>,</p>
						<td>
				</tr>
					<tr>
					<td style="padding: 30px 0;">
							<p style="font-size: 14px;color: #000;line-height: 19px;margin:0;"><?php echo isset($head_title) ? $head_title : ''; ?></p>
						</td>
					</tr>
					<tr>
						<td>
							<p style="font-size: 14px;color: #9B9B9B;line-height: 19px;margin:0;"><?php echo $message; ?></p>
						</td>
					</tr>
					<tr>
