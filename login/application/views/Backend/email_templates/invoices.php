            ...
            <tr>
                <td align='left' style='background: #ffffff; border: 1px solid #dce1e5;' valign='top' width=''>
                    <table border='0' cellpadding='0' cellspacing='0' width='100%'>
                        <tr>
                            <td align='center' valign='top'>
                                <h2>Invoice of Cherrymenu!</h2>
                                <p>Hello <b><?php echo $name; ?></b>,You have been assign package.</p>
                            </td>
                        </tr>
                        <tr>
                            <td align='center' style='border-top: 1px solid #dce1e5;border-bottom: 1px solid #dce1e5;' valign='top'>
                                ...
                                <p style='margin: 1em 0;'>
                                    <strong>Package Name:</strong>Free Trial
                                </p>
                                <p style='margin: 1em 0;'>
                                    <strong>Price:</strong><?php echo $price ?>
                                </p>
                                <p style='margin: 1em 0;'>
                                    <strong>Expired Date:</strong>25-10-2018
                                </p>
                            </td>
                        </tr>
                        <tr>
