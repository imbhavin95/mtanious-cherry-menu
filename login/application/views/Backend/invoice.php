...
<body>
    ...
    <div style="width:100%;border-bottom: 1px solid #777;padding:0 0 15px 0">
      ...
      <div style="width:30%;float:right;padding-top:20px;">
        ...
        <b>Date</b> <?php echo isset($package_detail['created_at']) ? date('d M Y', strtotime($package_detail['created_at'])) : '-' ?>
      </div>
  </div>
...
<table style="border:1px solid #777;width:100%;border-spacing:0;">
    ...
    <tr>
      <td style="border-bottom:1px solid #ddd;padding:5px 10px;font-size:13px"></td>
      <td style="border-bottom:1px solid #ddd;padding:5px 10px;font-size:13px"></td>
      <td style="border-bottom:1px solid #ddd;padding:5px 10px;font-size:13px">Total : <?php echo isset($package['price']) ? 'AED '.$package['price'] : '-' ?></td>
    </tr>
	</tbody>
</table>
