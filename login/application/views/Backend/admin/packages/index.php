                    ...
                    },
                    {
                        ...
                        render: function (data, type, full, meta) {
                            ...
                            // if (full.is_active == 1) {
                                ...
                                action +='<a class="icons-design" href="admin/packages/edit/' + btoa(full.id) + '"><img src="<?php echo base_url('public/edit-change-pencil.svg'); ?>"></a>&nbsp;'
                                ...
                                action +='<a class="icons-design" href="'+ deleteurl +'admin/packages/delete/'+ btoa(full.id) + '" onclick="return confirm_alert(this)"><img src="<?php echo base_url('public/Trashcan.svg'); ?>"></a>&nbsp;'
