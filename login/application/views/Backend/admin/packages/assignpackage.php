                  ...
                  <div class="col-md-12">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="name" class="form-label">Restaurants</label> <span class="require-field">*</span>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="arabic_name" tabindex="1" name="arabic_name" placeholder="Enter Arabic Name" value="<?php echo (isset($package) && $package['arabic_name']) ? $package['arabic_name'] : set_value('arabic_name'); ?>">
                            </div>
                        </div>
                  </div>
                  <div class="col-md-12">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" id="price" name="price" tabindex="2" placeholder="Enter Price" value="<?php echo (isset($package) && $package['price']) ? $package['price'] : set_value('price'); ?>">
                            </div>
...
$(document).ready(function(){
    ...
    $('#packages').validate(
    {
        rules:
        {
            ...
            "discount":{required:true,digits: true,max:100},
            "date":{required:true},
