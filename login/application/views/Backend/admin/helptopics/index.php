                    ...
                    },
                    {
                        ...
                        render: function (data, type, full, meta) {
                            ...
                            // if (full.is_active == 1) {
                                ...
                                action +='<a class="icons-design" href="admin/helptopics/edit/' + btoa(full.id) + '"><img src="<?php echo base_url('public/edit-change-pencil.svg'); ?>"></a>&nbsp;'
                                ...
                                action +='<a class="icons-design" href="'+ deleteurl +'admin/helptopics/delete/'+ btoa(full.id) + '" onclick="return confirm_alert(this)"><img src="<?php echo base_url('public/Trashcan.svg'); ?>"></a>&nbsp;'
