                ...
                buttons: [
                    ...
                    },
                    {
                        ...
                        customize : function(doc) 
                        {
                            ...
                            doc.content[1].table.widths = [ '5%', '30%','30%', '15%','20%'];
                        }
                    }
                ],
                // ajax: '<?php //echo base_url("/restaurant/reports/get_category_reports"); ?>',
                ajax: {
                    'url': '<?php echo base_url("restaurant/reports/get_category_reports"); ?>',
                    "data": {
                        'startDate': startDate,
                        'endDate' : endDate
                    },
