...
<div class="page-header">
    ...
    <ol class="breadcrumb">
        ...
        <li><a href="<?php echo base_url('restaurant/orders'); ?>">Orders</a></li>
...
function bind()
{
    $('#items_click').dataTable({
                ...
                ajax: {
                    'url': '<?php echo base_url("restaurant/orders/get_reports"); ?>',
                    "data": {
                        'startDate': startDate,
                        'endDate' : endDate
                    },
    ...
    $(document).ready(function() {
        ...
        $('#date-range-picker').daterangepicker(null, function(start, end, label) 
        {
            ...
            startDate=$('.input-mini[name ="daterangepicker_start"]').val(); 
            endDate=$('.input-mini[name ="daterangepicker_end"]').val(); 
           //console.log(a);
