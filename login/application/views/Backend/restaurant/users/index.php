                    ...
                    },
                    {
                        ...
                        render: function (data, type, full, meta) {
                            ...
                            var deleteurl = '<?php echo base_url(); ?>';
                                ...
                                action +='<a class="icons-design" href="restaurant/users/edit/' + btoa(full.id) + '"><img src="https://www.cherrymenu.com/login/public/edit-change-pencil.svg"></a>&nbsp;'
                                ...
                                action +='<a class="icons-design" href="'+ deleteurl +'restaurant/users/delete/'+ btoa(full.id) + '" onclick="return confirm_alert(this)"><img src="https://www.cherrymenu.com/login/public/Trashcan.svg"></a>&nbsp;'
