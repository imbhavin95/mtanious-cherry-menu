                        ...
                        render: function (data, type, full, meta) {
                           ...
                           /* console.log( ' full='+full);
                            ...
                            var deleteurl = '<?php echo base_url(); ?>';
                                ...
                                action +='<a class="icons-design" href="restaurant/menus/edit/' + btoa(full.id) + '"><img src="<?php echo base_url('public/edit-change-pencil.svg'); ?>"></a>&nbsp;'
                                ...
                                if(menu_id != full.id)
                                {
                                action +='<a class="icons-design" href="'+ deleteurl +'restaurant/menus/delete/'+ btoa(full.id) + '" onclick="return confirm_alert(this)"><img src="<?php echo base_url('public/Trashcan.svg'); ?>"></a>&nbsp;'
                                }
