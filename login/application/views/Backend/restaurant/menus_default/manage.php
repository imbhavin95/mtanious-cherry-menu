...
<div class="page-header">
    ...
    <ol class="breadcrumb">
        <li><a href="<?php echo base_url('restaurant/menus_defalt/index'); ?>">Menus</a></li>
                ...
                <fieldset>
                  ...
                  <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        if(isset($menu['background_image']))
                        {
                            $path = RESTAURANT_IMAGES . '/' . $restaurant_id. '/menus_defalt/backgrounds/'.$menu['background_image'];
                  ...
                  <a href="<?php echo base_url('restaurant/menus_defalt'); ?>" class="btn btn-square" tabindex="8">Cancel</a>
                </fieldset>
              </form>
            </div>
      </div>
