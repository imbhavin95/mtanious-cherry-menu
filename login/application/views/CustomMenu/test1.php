  ...
  <div class="container-fluid">
    <div class="row">
     ...
     <select id="langid">
      ...
      <option value="1" <?php echo @$_COOKIE['langid']==1 ? 'selected':''; ?>>English</option>
      <option value="2" <?php echo @$_COOKIE['langid']==2 ? 'selected':''; ?>>Arabic</option>
    </select>
...
foreach ($item_data as $key => $value) {
     $catname=$value['name'];  
    $catnames[]=@$_COOKIE['langid']==2 ? $value['arabic_name'] : $value['name'];  
...
?>
  ...
  <div class="container-fluid">
    ...
    <nav class="navigation" id="mainNav">
      <div id="owl-example" class="owl-carousel ssssssss">
...
foreach ($item_data as $key => $value) {
  //$a > 15 ? 20 : 5; 
  $catname=@$_COOKIE['langid']==2 ? $value['arabic_name'] : $value['name'];
    // $catname=$value['name']; 
  ?>
      ...
      $url="https://www.cherrymenu.com/login/public/restaurants/".$restid."/items/"."$item_id"."/thumbnail/".$imgname;
        ...
        <div class="col-sm-4 col-md-4">
          <div class="item-img-name">
           ...
           <div class="item-des">
            <p><?php echo $atitlee=@$_COOKIE['langid']==2 ? $value3['arabian_title'] : $value3['title'];?></p>
