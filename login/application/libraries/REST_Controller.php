...
abstract class REST_Controller extends CI_Controller {
    ...
    public function _remap($object_called, $arguments = [])
    {
        ...
        if (str_contains($controller_method, '_post_post')) { 
            $controller_method_arr = explode('_', $controller_method);
            $arr_length = count($controller_method_arr);
            unset($controller_method_arr[$arr_length - 1]);
            $controller_method = implode('_', $controller_method_arr);
        }

        // print_r($controller_method_arr); exit;
