...
class V1_test extends CI_Controller
{
...
public function test(){
  ...
  public function test2121(){
    echo "string";
       $totalnoofusers=($this->db->query("SELECT * from totalnoofusers")->num_rows());
       $restaurantlist=($this->db->query("SELECT * from restaurantlist ")->num_rows());
       $totalnoofcategories=($this->db->query("SELECT * from totalnoofcategories ")->num_rows());
       $totalnoofitems=($this->db->query("SELECT * from totalnoofitems ")->num_rows());
       echo "<pre>";
       print_r($totalnoofusers);
       echo "<pre>";
       print_r($restaurantlist);
       echo "<pre>";
       print_r($totalnoofcategories); 
       echo "<pre>";
       print_r($totalnoofitems);
  }
