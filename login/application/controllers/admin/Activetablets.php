...
class Activetablets extends My_Controller
{
    ...
    {
        $data['title'] = WEBNAME.' | Active Tablets';
        $data['head'] = 'Active Tablets';
        $this->template->load('default', 'Backend/admin/activetablets/index', $data);
    }
