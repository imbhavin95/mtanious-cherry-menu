...
class Home_test extends My_Controller
{
    ...
    public function index()
    {
        ...
        $data['head'] = 'Dashboard';
        $data['total_users'] =2323; //($this->users_model->sql_select(TBL_USERS, 'id', ['where' => ['is_deleted' => 0,'restaurant_id' => $this->session->userdata('login_user')['id']]], ['count' => true]));
        $data['total_menus'] = 3333;//($this->users_model->sql_select(TBL_MENUS, 'id', ['where' => ['is_deleted' => 0,'restaurant_id' => $this->session->userdata('login_user')['id']]], ['count' => true]));
        ...
        $data['total_categories'] =  67845;
            //$data['categories'] = 78678;
            $data['total_items'] = 535;
